...
COMPLETED_SO_FAR: P00 accepted prompt fidelity and governance verified; P01 inventory and base selection complete; P02 isolated branch/worktree established; P03 live diagnosis passed and the confirmed fail-closed CSS visibility mechanism is repaired locally. Live root/API/assets/identity/isolation passed at 390 and 1440 with zero fatal console errors and zero Production crossover. Focused P03 tests passed 5 files/16 tests; the staging build and byte-identical hero verification passed. No provider, database, migration, reset, deployment, Production, Google, or Figma mutation occurred.
