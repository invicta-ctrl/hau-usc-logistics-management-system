...
COMPLETED_SO_FAR: P00–P08 local work is complete. The manifest-bound P08 audit established the six real bootstrap contracts and the Lending, Release, and Restocking defects. Focused repairs now project canonical linked Lending inventory and expose evidence-backed, capability-gated Release and Restocking commands through existing Worker/D1 contracts. Overview, Request, and Procurement remain backend-backed and truthful. Focused tests, the 1204-test full suite, Cloudflare build, fixture boundary, formatting, targeted JavaScript lint, and diff checks pass. No repair-step provider/business-data, deployment, Production, main, Google, or Figma mutation occurred; live post-repair acceptance remains sequenced for P29/P30.

NEXT_EXACT_ACTION: Begin P09 Events full recovery under the accepted root-cause order: capability, UI gate, Worker auth/endpoint, response contract, D1 relationships, adapter, loading/retry, underprivileged denial, and reset restoration.
