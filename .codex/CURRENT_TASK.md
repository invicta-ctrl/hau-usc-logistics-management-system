...
COMPLETED_SO_FAR: P00–P03 complete through local repair. P04 reproduced the deployed no-op Preview action and repaired canonical route/history state locally. The exhaustive 15-entry matrix passed at 390 and 1440 for click, main landmark/heading, Back, Forward, direct load, Index return, and reload persistence with zero mutation requests; off-origin inspection remains denied. The current deployed candidate is unchanged pending later deployment gates. No provider, database, migration, reset, deployment, Production, Google, or Figma mutation occurred.
