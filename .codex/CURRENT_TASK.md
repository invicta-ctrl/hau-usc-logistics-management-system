...
MODE: EXECUTE
OBJECTIVE: Retain immutable v1 and v2 failure evidence, with v2 failed pre-child at the host parser, and prepare only the final Class R v3 prevalidation and durable acceptance record without entering S00 or changing runtime, release, or provider state.
RESULT: PRIVATE_PRESERVATION_V3_PREVALIDATION_PENDING_FINAL_ATTEMPT
