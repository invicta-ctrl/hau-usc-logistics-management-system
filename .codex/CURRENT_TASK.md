...
STOP CONDITIONS: Any unexpected dirty path, changed baseline identity, authority conflict, out-of-scope mutation need, test failure, checkpoint push failure, or completed local checkpoint.
