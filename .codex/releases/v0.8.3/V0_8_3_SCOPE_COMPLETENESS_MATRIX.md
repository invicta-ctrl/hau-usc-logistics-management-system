...
| SOURCE_RECONCILIATION_PLAYGROUND_GATE     | COMPLETED_NONPASS: invoked once/no retry; aggregate safeFlags=false; one diagnostic confirms absent roster-source configuration/secret inventory; exact subtype unresolved; not ID-D |
