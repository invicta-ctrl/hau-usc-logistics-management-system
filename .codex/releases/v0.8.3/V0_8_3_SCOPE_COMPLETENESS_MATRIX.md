...
| ID-G                      | Staff/account operational activity history                                      | ACTIVE / REMAINING UNTIL VERIFIED CANONICAL INTEGRATION | Preserved 26-path isolated implementation; one focused Luna repair re-review is required before canonical integration.          |
| ID-H                      | Secure eight-digit verification lifecycle, including existing email integration | REMAINING                                               | One coherent provider-free implementation slice follows ID-G canonical integration.                                             |
...
## ID-G current evidence and gate

- **Canonical rehydration:** f3c28ba257e80fabb532979969ddd27cab0959db, tree f81d8ece7d44ff62d66656ac4da0c34265be835b, clean and upstream/live 0/0.
- **Isolated implementation:** 2aa73aeaf965d4eb55449e87c3cbda675730ba97; repaired/current c13bbdadf7fa46829a3a78dece66f08bfe111013, tree 9fd68d4e8c4b4d19e9e23793834365d35467b499, clean and upstream/live 0/0.
- **Authorized scope:** exact 26 Section 6 paths; outside authorized paths 0.
- **Prior independent review:** ACCEPT_WITH_REQUIRED_REPAIRS.
- **Required repair:** complete in exactly src/v5/integration/runtime.js, tests/e2e/v5-current-application.spec.js, and tests/unit/access-management-repository.test.js.
...
- **Remaining gate:** one focused Luna re-review of the repaired P1 real-Miniflare producer evidence and V5 race; no canonical integration before its disposition.
...
| MIGRATION_0032_DECISION                   | REQUIRED_BECAUSE_ACCEPTED_ID_G_INCLUDES_0032       |
| Migration application                     | STAGE_GATED; no shared/provider database execution |
| Candidate freeze                          | NOT_AUTHORIZED; ID-G and ID-H are not yet PASS     |
