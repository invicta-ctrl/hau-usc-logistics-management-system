...
BLOCKER: NONE
NEXT_EXACT_ACTION: Execute P31 as two independent guarded live mutation/reset cycles from the preserved generation-6 DIRTY state, proving D1/R2/profile/theme/workflow changes and complete restoration, old-session invalidation, new entry, and critical-route health after each reset.
