...
Resolve BRANCH, HEAD, UPSTREAM, and WORKTREE_STATE during the Git handshake. The completed v0.7.2.1 specification remains the closeout authority until a v0.7.3 specification is accepted.
