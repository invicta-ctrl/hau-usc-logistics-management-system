...
STATUS: ACTIVE
PHASE: P07_GENERATION_4_CLEAN_RESET_COMPLETE;P07_V2_INSTALL_NEXT
...
P07_STATUS: LOCAL_V2_CANDIDATE_VERIFIED;RESET_ATTEMPT_A_RECOVERED;GENERATION_4_RESET_PASS;V2_INSTALL_NOT_STARTED
...
BLOCKER: NONE
NEXT_EXACT_ACTION: Commit and push the generation-4 clean-reset checkpoint. Do not repeat the reset. Reconfirm clean Git/upstream and generation-4 live state, prove fresh private v2 manifest/report/export targets are absent, then run the v2 installer once with the verified v3 additive overlay.
