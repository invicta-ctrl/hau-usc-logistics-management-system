...
export function AuthMobileDrawer({
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-4" style={{ borderBottom: "1px solid rgba(242,209,92,0.18)" }}>
          <div className="flex flex-col items-start gap-1">
            <CombinedLockup width={124} />
        ...
        <div className="flex-1 overflow-y-auto px-2 py-4 flex flex-col gap-4">
          <nav className="flex flex-col gap-0.5" aria-label="Operations">
            ...
            {NAV_OPERATIONS.map((item) => (
              ...
              >
                <item.Icon size={15} strokeWidth={1.6} color={route === item.route ? "#e8b93c" : "rgba(250,238,203,0.65)"} />
                <span style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif", fontSize: 14, color: route === item.route ? "#faeecb" : "rgba(250,238,203,0.75)", letterSpacing: -0.15 }}>
                  {item.label}
                </span>
              </button>
            ))}
          ...
          <nav className="flex flex-col gap-0.5" style={{ borderTop: "1px solid rgba(242,209,92,0.1)", paddingTop: 16 }} aria-label="Administration">
            <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: "rgba(250,238,203,0.38)", letterSpacing: "1px", textTransform: "uppercase", paddingLeft: 12, marginBottom: 4 }}>
              Administration
            </p>
        ...
        {/* Footer */}
        <div className="px-4 pb-6 pt-3 flex flex-col gap-3" style={{ borderTop: "1px solid rgba(242,209,92,0.12)" }}>
          <div className="flex items-center justify-between">
            <span style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif", fontSize: 11, color: "#f6e29a" }}>Theme</span>
          ...
          >
            ...
            <span style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif", fontSize: 13, color: "rgba(250,238,203,0.6)", letterSpacing: -0.1 }}>
              Sign out
            </span>
          </button>
        </div>
