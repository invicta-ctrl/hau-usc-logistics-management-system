...
function Text20() {
  return (
    <div clas…9952 tokens truncated… leading-[normal] relative shrink-0 text-[#241416] text-[11px] text-center tracking-[-0.11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Review
      </p>
    </div>
  );
