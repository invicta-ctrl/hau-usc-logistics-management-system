...
const STATUS_CFG: Record<ReqStatus, { label: string; bg: string; color: string; border: string; dot: string }> = {
  "in-review":        { label: "In DOL review",    bg: "rgba(232,185,60,0.15)",  color: "#7d5518", border: "rgba(200,153,47,0.32)", dot: "#c8992f" },
  ...
  "closed":           { label: "Closed",            bg: "rgba(111,90,96,0.10)",   color: "#6f5a60", border: "rgba(111,90,96,0.22)",  dot: "#8a7278" },
};
...
function UrgencyBadge({ urgency }: { urgency: ReqUrgency }) {
  ...
  return (
    <span
      ...
      style={{ fontFamily: sans, fontSize: 10, fontWeight: 500, background: "rgba(111,90,96,0.10)", color: "#6f5a60", border: "1px solid rgba(111,90,96,0.20)" }}
    >
      Escalated
    </span>
  );
    ...
    <>
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="rc-title" style={panelStyle}>
        ...
        <div className="flex items-center justify-between px-5 py-3 shrink-0" style={{ borderBottom: `1px solid ${c.border}` }}>
          {isMobile ? (
            <button
              ...
              type="button"
              onClick={onClose}
              className="inline-flex items-center gap-2 rounded-[6px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="inline-flex items-center justify-center rounded-[8px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
        ...
        <div className="px-5 pt-5 pb-4 shrink-0" style={{ borderBottom: `1px solid ${c.border}` }}>
          ...
          <div className="mt-3 inline-block rounded-[5px] px-2 py-0.5" style={{ background: dark ? "rgba(232,185,60,0.08)" : "#fbeed2", border: "1px solid #dcbe8a" }}>
            ...
            <div className="flex flex-col rounded-[8px] overflow-hidden" style={{ border: `1px solid ${c.border}` }}>
              {item.detailLines.map((line, i) => (
                <div
                  ...
                  style={{ background: c.m1, borderTop: i > 0 ? `1px solid ${c.border}` : "none" }}
                >
                  <div className="flex items-center justify-between gap-3">
                    <span style={{ fontFamily: sans, fontSize: 12, color: c.text }}>{line.name}</span>
                  ...
                  <select
                    defaultValue=""
                    aria-label={`Route decision for ${line.name}`}
                    style={{ fontFamily: sans, fontSize: 12, color: c.text, background: c.m2,
          ...
          <div className="px-5 py-4 shrink-0" style={{ borderBottom: `1px solid ${c.border}` }}>
            ...
            {activeAction ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="rounded-[8px] px-4 py-3" style={{ background: "rgba(232,185,60,0.07)", border: "1px solid rgba(232,185,60,0.28)" }}>
                  <p style={{ fontFamily: mono, fontSize: 9, color: "#7d5518", letterSpacing: "0.8px", textTransform: "uppercase", marginBottom: 3 }}>
                    Local review only
                  </p>
                  <p style={{ fontFamily: sans, fontSize: 11, color: dark ? "rgba(250,238,203,0.7)" : "#7d5518", lineHeight: "16px" }}>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 rounded-[8px] py-2.5 text-[13px] font-semibold transition-opacity hover:opacity-85 active:opacity-70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
                    style={{
                      fontFamily: sans, cursor: "pointer",
                      background: ACTION_CFG[activeAction].danger ? "rgba(212,24,61,0.10)" : (dark ? "#e8b93c" : "#40070a"),
                      color:      ACTION_CFG[activeAction].danger ? "#c8152a" : (dark ? "#40070a" : "#faeecb"),
                  ...
                  <button
                    ...
                    className="rounded-[8px] px-4 py-2.5 text-[13px] transition-opacity hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
                ...
                {(["accept","fulfil","ask","canvass","reject"] as ActionType[]).map((action) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={done}
                      aria-pressed={done}
                      className="flex items-center justify-between gap-2 rounded-[8px] px-4 py-3 text-left w-full transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
                      style={{
          ...
          <div className="px-4 py-3 flex flex-col sm:flex-row gap-3 flex-wrap" style={{ borderBottom: `1px solid ${c.border}` }}>
            <div className="relative" style={{ flex: "0 0 260px", maxWidth: "100%" }}>
              ...
              <input
                ...
                className="w-full rounded-[8px] pl-8 pr-3 py-2 text-[12px] focus:outline-none focus:ring-2 focus:ring-[#e8b93c]"
            ...
            <div className="flex flex-wrap gap-1.5 items-center">
              {FILTER_OPTIONS.map(({ status }) => {
                ...
                return (
                  <button
                    ...
                    className="rounded-full px-3 py-1 text-[11px] whitespace-nowrap transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
              ...
              {(statusFilter.length > 0 || search) && (
                <button
                  ...
                  className="rounded-full px-3 py-1 text-[11px] whitespace-nowrap transition-opacity hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 gap-3">
              ...
              <button
                type="button"
                onClick={clearFilters}
                className="rounded-[8px] px-4 py-2 text-[12px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
                style={{ fontFamily: sans, color: "#e8b93c", background: "none", border: `1px solid ${c.border}`, cursor: "pointer" }}
              >
                Clear filters
              </button>
            </div>
              ...
              {filtered.map((item, i) => {
                ...
                return (
                  <button
                    ...
                    className="flex flex-col gap-2 px-4 py-4 text-left w-full transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-inset focus-visible:outline-[#e8b93c]"
                    style={{ background: isSelected ? (dark ? "#2d2520" : "#fcf2cf") : c.m1, borderTop: i > 0 ? `1px solid ${c.border}` : "none", borderLeft: isSelected ? "3px solid #c8992f" : "3px solid transparent" }}
                  ...
                  {filtered.map((item, i) => {
                    ...
                    return (
                      <tr
                        key={item.id}
                        style={{
                          background: isSelected ? (dark ? "#2d2520" : "#fcf2cf") : (i % 2 === 0 ? c.m1 : (dark ? "#222120" : "#faf7f2")),
                      ...
                      >
                        ...
                        <td className="px-4 py-3" style={{ maxWidth: 280 }}>
                          <button
                            ...
                            className="text-left w-full rounded-[4px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#e8b93c]"
                            aria-pressed={isSelected}
                          >
