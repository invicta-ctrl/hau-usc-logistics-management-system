/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2ad344863982c357f54403359587a81)
// Runtime types generated with workerd@1.20260721.1 2026-07-22
interface __BaseEnv_Env {
  BRAND_ASSETS: R2Bucket;
  EVIDENCE_ASSETS: R2Bucket;
  DB: D1Database;
  ASSETS: Fetcher;
  ...
  CANDIDATE_SHA: 'REPLACE_AT_CANDIDATE_FREEZE' | 'LOCAL_UNFROZEN';
}
declare namespace Cloudflare {
  ...
  interface StagingEnv {
    ...
    SCHEMA_VERSION: '1.0.0';
    BOOTSTRAP_CONTRACT_VERSION: '2';
    CANDIDATE_SHA: 'REPLACE_AT_CANDIDATE_FREEZE';
  }
