...
export function publicShell(inner, { wide = false, back = true, dark = publicDark } = {}) {
  return `<div class="public">
    ...
    <footer class="public__foot">
      <span>© 2026 HAU-USC Logistics Management System</span>
      <span><a href="#/public.policy">Privacy Notice and Acceptable Use</a></span>
    </footer>
  </div>`;
}
...
export const landing = () =>
  publicShell(
    `<div class="public__head">
      <h1>What do you need from the Department of Logistics?</h1>
      <p>Choose a portal to begin. You can track anything you submit with the reference number we give you.</p>
    </div>
...
export const applicationStatus = () =>
  publicShell(
    `<div class="public__head">
      ...
      <p>Reference <b>APP-00214</b></p>
    </div>
    <div class="panel"><div class="panel__body">
      ${timeline([
        { title: 'Application received', meta: '3 August 2026', done: true },
        { title: 'Email confirmed', meta: '3 August 2026', done: true },
      ...
      <fieldset>
        ...
        <div style="display:grid;gap:16px">
          ...
          ${field({
            label: 'Linked event',
            name: 'evt',
            options: ['Not linked', 'Youth Development Days · Day 1', 'Youth Development Days · Day 2', 'General Assembly'],
          })}
          ${field({
            label: 'Purpose',
            name: 'p',
...
export function requestTracking({ state }) {
  if (state === 'empty') {
    return publicShell(
      ...
      <form class="form-grid" onsubmit="return false">
        ${field({ label: 'Reference number', name: 'ref', hint: 'For example, REQ-000318.' })}
  ...
  if (state === 'success') {
    return publicShell(
      ...
      ${receipt({
        ...
        lines: [
          { label: 'Submitted', value: '7 August 2026, 9:32 AM' },
          { label: 'Organisation', value: 'USC Executive Board' },
          { label: 'Event', value: 'Youth Development Days · Day 1' },
          { label: 'Items', value: '6 lines' },
          { label: 'Date needed', value: '19 August 2026' },
  ...
  return publicShell(
    `<div class="public__head"><h1>Request REQ-000318</h1>
      <p>Youth Development Days · Day 1 — submitted 7 August 2026</p></div>
    <div class="panel"><div class="panel__body" style="display:grid;gap:24px">
      ...
      ${timeline([
        { title: 'Submitted', meta: '7 August 2026, 9:32 AM', done: true },
...
export const lendingTracking = () =>
  publicShell(
    `<div class="public__head"><h1>Loan LOAN-00128</h1><p>Tent, 10 × 10 — requested 5 August 2026</p></div>
    <div class="panel"><div class="panel__body" style="display:grid;gap:24px">
      <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
        ${chip('READY_TO_CLAIM')}<span class="muted" style="font-size:var(--t-sm)">Claim by 14 August 2026</span>
      </div>
      ${timeline([
        { title: 'Requested', meta: '5 August 2026', done: true },
        { title: 'Reviewed and approved', meta: '6 August 2026', done: true },
      ...
      ${facts([
        { label: 'Return by', value: '14 August 2026' },
