...
<html lang="en">
  <head>
    ...
    <title>HAU-USC Logistics · Whole-site redesign preview v3</title>
    <!--
      Generated export. Do not edit.
      Authoritative source: prototypes/impeccable-whole-site-redesign-v3/
      Regenerate: node prototypes/impeccable-whole-site-redesign-v3/tools/export.mjs
...
${css}
  ...
  <body data-theme="light">
    <!-- DIRECTION CONTRACT: Calm institutional operations; bright paper or charcoal;
      oxblood anchors, restrained gold, purposeful motion, and no generic spinners. -->
...
const outFile = join(outDir, 'HAU_USC_Logistics_Impeccable_Whole_Site_Redesign_Preview_v3.html');
