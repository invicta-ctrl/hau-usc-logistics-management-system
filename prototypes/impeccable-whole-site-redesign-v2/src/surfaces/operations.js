        ...
        : state === 'empty'
          ...
          : queueTable({
              ...
              rows: rows.map((r) => ({
                ref: r.ref,
                cells: [
                  rowLink(r.ref, r.title, `${r.ref} · ${r.org}`, 'go:request.detail'),
...
export function requestQueue({ state, selected }) {
  ...
  const table = queueTable({
    ...
    selectedRef: selected ?? 'REQ-000318',
    rows: REQUESTS.map((r) => ({
      ref: r.ref,
      cells: [
...
function requestDetailPanel(state) {
  ...
  return `<aside class="split__detail" aria-label="Request detail">
    <div class="detail__head">
      ...
      <p class="muted" style="font-size:var(--t-xs)">REQ-000318 · USC Executive Board · needed 19 August 2026</p>
    </div>
    <div class="detail__body">
      ...
      ${facts([
        ...
        { label: 'Submitted', value: '7 August 2026' },
...
function routeControl(route) {
  ...
  return `<select aria-label="Routing decision" style="min-height:34px;padding:5px 8px;border:1px solid ${
...
export function lendingDetail() {
  return `${pageHead({
    crumbs: ['Office Lending Hub', 'LOAN-00121'],
    title: 'Portable PA system',
    lede: 'Loan LOAN-00121 · College of Education Council',
  ...
  <div class="rails" style="margin-top:16px">
    <div class="panel"><div class="panel__body">
      ...
      ${facts([
        ...
        { label: 'Return by', value: '3 August 2026' },
        { label: 'Borrower type', value: 'USC officer' },
        { label: 'Quantity', html: qty(1, 'set') },
        { label: 'Handed over', value: '28 July 2026' },
    ...
    <div class="panel"><div class="panel__body">
      ...
      ${timeline([
        { title: 'Requested', meta: '26 July 2026', done: true },
        { title: 'Approved', meta: '27 July 2026', done: true },
        { title: 'Handed over', meta: '28 July 2026 · recipient confirmed', done: true },
        { title: 'Overdue', meta: 'Since 3 August 2026', current: true },
  ...
  <div class="panel" style="margin-top:16px"><div class="panel__body" style="display:flex;gap:8px;flex-wrap:wrap">
    <button class="btn btn--primary" type="button" data-act="confirm-return">${icon('check')}Record return</button>
...
export function releaseDesk({ state }) {
  ...
  if (state === 'success')
    return `${head}${notice({
      tone: 'done',
      title: 'Partial release recorded for REQ-000305',
...
function partialPanel() {
  return `<section class="section">
    <div class="section__head"><h2>Record a release · REQ-000305</h2></div>
...
export function inventoryItem() {
  return `${pageHead({
    crumbs: ['Inventory Management', 'ITM-00104'],
    title: 'Extension cord, 10 m',
    lede: 'Equipment · Reusable Asset · ITM-00104',
  ...
  <div class="rails" style="margin-top:16px">
    ...
    <div class="panel"><div class="panel__body">
      ...
      <div class="table-wrap"><table class="ledger">
        <caption class="visually-hidden">Append-only movement history for ITM-00104.</caption>
...
export function restockingQueue({ state }) {
  ...
  if (state === 'partial')
    return `${head}${notice({
      tone: 'progress',
      title: 'RST-00057 is partially received',
