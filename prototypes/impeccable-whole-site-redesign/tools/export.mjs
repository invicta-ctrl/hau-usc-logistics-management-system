...
<html lang="en">
  <head>
    ...
    <!--
      ...
      Authoritative source: prototypes/impeccable-whole-site-redesign/
      Regenerate: node prototypes/impeccable-whole-site-redesign/tools/export.mjs
...
const outFile = join(outDir, 'HAU_USC_Logistics_Impeccable_Whole_Site_Redesign_Preview.html');
