...
export const CAPABILITIES = Object.freeze({
  ...
  LENDING_USAGE_VIEW: 'lending.usage.view',
...
const ROLE_ALIASES = Object.freeze({
  ...
  'SYSTEM OWNER': ROLES.SYSTEM_OWNER,
...
export function can(roleOrUser, action) {
  ...
  if (action === 'reset_demo') return [ROLES.ADMINISTRATOR, ROLES.SYSTEM_OWNER].includes(roleId);
