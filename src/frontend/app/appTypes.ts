...
export type EntryIntent =
  'GENERIC_STAFF_SIGN_IN' | 'EXTERNAL_REQUEST_CENTER' | 'INTERNAL_REQUEST_HUB' | 'OTHER_INTERNAL_DESTINATION';
...
export type Session = {
  ...
  /** Server-derived lending/evidence action gates. These only control presentation; the Worker rechecks. */
