...
| `DRIVE_FOLDER_INVALID`                     | Missing access, wrong key, deleted/moved folder             | Stop upload; validate the root and all eleven canonical exact-child/private mappings; never fall back             |
