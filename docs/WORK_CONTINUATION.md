...
- **Tests verified:** exact implementation commit `d54e733f3936513bb2305e53fa95d984060c28a4` passes the complete `npm run check` from an isolated worktree: governance, lint, 71 files / 464 Vitest, build, deterministic Apps Script parity, distribution verification, Cloudflare types, and dry-run. Fresh migrations 0001–0027 pass; focused local Worker authorization/history/null/TBA cases pass; protected mobile 390×844 and desktop 1440×900 Event Management paths pass.
