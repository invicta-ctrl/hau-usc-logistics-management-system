...
- **Tests verified:** `npm run check` 113 files / 770 tests; Playwright 136 passed / 356 intentional skips; local Worker/D1 39/39; migration 0001-0030 integrity `ok` and zero foreign-key findings.
