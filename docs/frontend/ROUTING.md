...
| FE-R3-003 | P2 | **Closed by MFR-002 U04.** Public Lending delegates Home and Staff Sign In to the persistent public shell and keeps only its three local view switches. |
...
| FE-R3-011 | P3 | **Closed by MFR-002 U02 + U04.** The generated foundation defines the type/radius contracts, and Public Lending now consumes the shared radius roles. |
...
| FE-R3-013 | P2 | **Closed by MFR-002 U04.** The access and recovery panels now share semantic theme roles across every generated Light/Dark appearance; declared literal values are fallback-only. |
