...
function resolveMaterialsRequestsEnabled_(properties) {
  return resolveBooleanRuntimeProperty_(properties || PropertiesService.getScriptProperties(), HAU_RUNTIME_PROPERTIES.MATERIALS_REQUESTS_ENABLED, false);
}

function resolveVenueEquipmentRequestsEnabled_(properties) {
...
var HAU_HEADERS = Object.freeze({
  ...
  '10_CANVASS': ['Canvass_ID','Created_At','Updated_At','Linked_Request_Line_ID','Linked_Deliverable_ID','Linked_Restock_ID','Supplier_ID','Supplier_Name','Location','Item_Spec','Price','Unit','Receipt_Status','Supplier_TIN','Reliability','Checked_At','Source_URL','Evidence_ID','Preferred','Preferred_Rationale','Status','Created_By','Price_History_JSON','Idempotency_Key','Revision','Archived_At','Archived_By','Archive_Reason','Notes'],
